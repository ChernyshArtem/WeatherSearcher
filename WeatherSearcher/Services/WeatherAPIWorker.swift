...
class WeatherAPIWorker {
    static func findWeatherWithMinMaxTemp(completion: @escaping (WeatherResponse, Double, Double) -> () ) {
        let headers: HTTPHeaders = [
            "X-RapidAPI-Key": "a27f2b7e3cmshca1d4f8766af5c5p16ced7jsndf386e8586ce",
            "X-RapidAPI-Host": "weatherapi-com.p.rapidapi.com"
        ]
        AF.request("https://weatherapi-com.p.rapidapi.com/forecast.json?q=Minsk&days=3", headers: headers).response { response in
